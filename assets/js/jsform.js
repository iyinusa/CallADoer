...
$(function () {
	...
	$(form).submit(function (event) {
		...
		$(formMessages).html('<div class="text-center col-lg-12"><i class="fa fa-spinner icon-line-awesome-spinner fa-2x fa-fw"></i> please wait...</div>');
	...
	$(form2).submit(function (event) {
		...
		// show prograss loading
		$(formMessages2).html('<div class="text-center col-lg-12"><i class="fa fa-spinner icon-line-awesome-spinner fa-2x fa-fw"></i> please wait...</div>');
