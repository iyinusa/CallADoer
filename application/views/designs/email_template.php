...
<style>
	...
	.mhead{font-size:18px; padding-bottom:20px; background-color:#040B25; padding:15px; margin-bottom:15px; color:#fff; text-align:center; font-weight:bold;}
	...
	.mbtn .btn1{background-color: #040B25;}
</style>
</head>
...
<body>
	<div id="m_wrap"> 
        <div id="m_box">
            <div class="mhead">
                <div class="mlogo">
                    <img alt="<?php echo app_name; ?>" src="<?php echo base_url(); ?>assets/images/logo.png" style="max-width:100%;" />
                </div>
				<?php echo $subhead; ?>
            </div>
